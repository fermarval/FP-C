...
SRC_FILES3=asignatura.c cadena.c tipoAsignatura.c testAsignatura.c
TARGET3=$(BIN_DIR)testAsignatura.exe

SRC_FILES4=grado.c asignatura.c cadena.c tipoAsignatura.c testGrado.c
TARGET4=$(BIN_DIR)testGrado.exe

SRC_FILES5=tipoEspacio.c testTipoEspacio.c
TARGET5=$(BIN_DIR)testTipoEspacio.exe

SRC_FILES6=espacio.c cadena.c tipoEspacio.c testEspacio.c
TARGET6=$(BIN_DIR)testEspacio.exe

SRC_FILES7=espacio.c tipoEspacio.c centro.c cadena.c testCentro.c
